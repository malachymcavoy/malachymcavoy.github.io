...
data analyst, particularly in the field of sports. I not only have a tremendous knowledge of 
all major sports, but I understand the power that sports has to bring together communities 
in times of need and unite people around a common cause. While the world we live in seems to 
be in constant turmoil, sports has the ability to make us forget all of that and enjoy 
the simple things in life.

My research utilizes econometric/machine learning to analyze how certain variables affect a players draft position. To expand even further, I wish to examine if these variables have any correlation in predicting a player's long term success in the league. I will be using draft, combine and college data from the past 20 years for my project. 
